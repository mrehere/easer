    ...
    <footer className="footer">
      ...
      <div onClick={() => clickJournal()} className="footer__journalContainer">
        <svg
          ...
          viewBox="0 -960 960 960"
          width={`${iconSize}px`}
          fill={routeStatus === "/journal" ? "#a5d6a7" : "#FFFFFF"}
        >
        ...
        <p
          className={`footer__journal ${
            routeStatus === "/journal" ? "footer__journal--active" : ""
          }`}
        >
          Journal
        </p>
      ...
      <div onClick={() => clickMood()} className="footer__moodContainer">
        <svg
          ...
          viewBox="0 -960 960 960"
          width={`${iconSize}px`}
          fill={routeStatus === "/mood" ? "#a5d6a7" : "#FFFFFF"}
        >
        ...
        <p
          className={`footer__mood ${
            routeStatus === "/mood" ? "footer__mood--active" : ""
          }`}
        >
          Mood
        </p>
